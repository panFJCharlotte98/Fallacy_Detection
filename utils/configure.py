...
class Configure(object):
    ...
    def refresh_args_by_file_cfg(file, prev_args):
        # file: task config file--META_TUNING/task_name.cfg
        # prev_args: Args() processed from experiment config file--Salesforce/T5_base_xxx.cfg
